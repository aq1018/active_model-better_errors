...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/aq1018/activemodel-better-errors"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.24"
  s.summary = "ActiveModel::Errors class is not designed for API consumption. This gem allows for that while keeping compatibility with existing rails API."
